...
def federated_learning_evaluation(num_of_clients):
    ...
    #pd.DataFrame(average_training_aucs).to_csv("./non-IID_evaluation/"+ str(num_of_clients) + "simple_average_training_aucs.csv",
    #                                           header=False, index=False)
    pd.DataFrame(end_of_loop_test_aucs).to_csv("./non-IID_evaluation/"+ str(num_of_clients) + "average_shared_data_test_aucs.csv",
                                               header=False, index=False)
